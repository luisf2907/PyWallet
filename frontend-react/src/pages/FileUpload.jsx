    ...
    <Layout>
      ...
      {hasHoldings && <CompactHoldingsTable holdings={holdings} />}
        ...
        sx={{
          ...
          width: hasHoldings ? 'calc(100% - 310px)' : undefined, // Considerar o espaço para a tabela compacta (280px + 30px de margem)
          mr: hasHoldings ? '310px' : 'auto', // Garantir espaço à direita para a tabela
