...
const FeatureCard = ({ icon, title, description }) => (
  <Card 
    elevation={4}
    sx={{ 
      height: 220, // Altura fixa aumentada
      width: '100%',
      display: 'flex',
      flexDirection: 'column',
  ...
  >
    <CardContent 
      sx={{ 
        ...
        gap: 2 // Espaçamento uniforme entre elementos
      }}
    >
      {/* Ícone - espaço fixo */}
      <Box 
          ...
          <Grid container spacing={6} alignItems="center">
            <Grid item xs={12} md={6}>
              <Stack spacing={4}>
                ...
                >
                  Organize seus investimentos de um jeito simples
                </Typography>
                <Typography 
                  variant="h6" 
                  color="text.secondary"
                ...
                >
                  Dashboards intuitivos, análises automáticas e controle total do seu portfólio. 
